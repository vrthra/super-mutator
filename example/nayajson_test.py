...
def suite():
    ...
    suite.addTest(TestJsonTokenization('test_array_stream'))
    suite.addTest(TestJsonTokenization('test_number_parsing'))
    suite.addTest(TestJsonTokenization('test_operator_parsing'))
    suite.addTest(TestJsonTokenization('test_string_parsing'))
    suite.addTest(TestJsonTokenization('test_sequence'))
    suite.addTest(TestJsonTokenization('test_arrays'))
    suite.addTest(TestJsonTokenization('test_objects'))
    suite.addTest(TestJsonTokenization('test_array_stream'))
    #def test_large_sample(self):
    return suite
